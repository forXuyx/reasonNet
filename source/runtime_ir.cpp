...
namespace rnet {
    ...
    void RuntimeGraph::InitGraphParams(
        ...
        for (const auto &[name, parameter]: params) {
            ...
            switch (type) {
                case int(RuntimeParameterType::rParameterUnknown): {
                    RuntimeParameter *runtime_parameter = new RuntimeParameter;
                    runtime_operator->params.insert({name, runtime_parameter});
                    break;
                }

                case int(RuntimeParameterType::rParameterBool): {
                ...
                case int(RuntimeParameterType::rParameterInt): {
                ...
                case int(RuntimeParameterType::rParameterFloat): {
                ...
                case int(RuntimeParameterType::rParameterString): {
                ...
                case int(RuntimeParameterType::rParameterIntArray): {
                ...
                case int(RuntimeParameterType::rParameterFloatArray): {
                ...
                case int(RuntimeParameterType::rParameterStringArray): {
